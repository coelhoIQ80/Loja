...
public class Perecivel extends Produto
{
     ...
     * @param validade
     ***********************************************************/
    public Perecivel(int codigo, double preco, String nome, String unidade,
	    CodigoBarras cb, Data validade)
    {
    ...
    {
	return "(P) " + super.valores()
		+ String.format(" %10s %15s", validade, getCodigoBarras());
    }
