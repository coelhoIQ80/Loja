...
public class Testes
{
	...
	public static void inicializaFactura()
	{
		...
		p1 = new Perecivel(1024, 0.6, "Imperial", "cl", new CodigoBarras("5601234567712"), new Data(10, 3, 2009));
		p2 = new NaoPerecivel(855, 1.1, "Coca-Cola", "cl", new CodigoBarras("5601232257712"), new Data(25, 12, 2009));
		p3 = new Perecivel(777, 0.45, "Café", "cl", new CodigoBarras("5601234527712"), new Data(10, 3, 2009));
	...
	public static void testaReflexividade()
	{
		...
		for (int i = 0; i < f2.size(); i++)
			System.out.println(f2.get(i) + (f2.get(i).getProduto() instanceof Perecivel ? " (P)" : " (NP)"));
	}
	...
	public static void testaCopiarAlterar()
	{
		...
		Produto p4 = new Perecivel(373, 1.15, "Bolo", "g", null, new Data(10, 3, 2009));
	...
	public static void testaOrdenar()
	{
		...
		Produto p4 = new Perecivel(373, 1.15, "Bolo", "g", new CodigoBarras("5601234511882"), new Data(10, 3, 2009));
	...
	public static void testaTimer()
	{
		...
		{		
			...
			public void actionPerformed(ActionEvent event)
			{
				...
				f2.adiciona(f2.get(pos).getProduto(), n.nextDouble() * f2.get(pos).getQuantidade());
				System.out.println(f2);
			}
		}
