...
*
***********************************************************/
public class WProduto extends JanelaProduto
{
...
//    private JFrame chamadora;
	...
	public void actionPerformed(ActionEvent event)
	{
	    ...
	    JOptionPane.showMessageDialog(janelaProduto, "Inserido produto "
		    + p + " na base de dados!", "Sucesso",
	...
	public void actionPerformed(ActionEvent event)
	{
	    ...
	    if (JOptionPane.showConfirmDialog(janelaProduto, "Remover produto "
		    + p + " da base de dados?", "Confirmar",
	...
	public void actionPerformed(ActionEvent event)
	{
		...
		data.setBorder(new TitledBorder(new EtchedBorder(),
			"Data de Validade"));
	    else
		data.setBorder(new TitledBorder(new EtchedBorder(),
			"Data de Fabrico"));
    ...
    ***********************************************************/
	...
	case 'p':
	case 'P':
	    p = new Perecivel(codigo, preco_venda, nome, unidade, 
		    new CodigoBarras(barras), new Data(dia, mes, ano));
	    break;
	case 'n':
	case 'N':
	    p = new NaoPerecivel(codigo, preco_venda, nome, unidade, 
		    new CodigoBarras(barras), new Data(dia, mes, ano));
	    break;
	default:
    ...
    ***********************************************************/
	...
	Data d = p instanceof Perecivel ? ((Perecivel) p).getValidade() 
		                        : ((NaoPerecivel) p).getFabricado_em();
    ...
    ***********************************************************/
    ...
    {
	this.setLocation(chamadora.getX() + SHIFT_X, 
			 chamadora.getY() + SHIFT_Y);
